...
1.  `pip install` or `conda install` the following Python packages: `beautifulsoup4, requests, pandas, numpy`; these are already in the environment if you are using Docker.  **Note: You may need to install `lxml` to parse the table.**
...
3. (c) a short prose description of how your code works. 

For Questions 1 and 2 of Part 2, follow the instructions there. 

For Question 3 of part 2 provide: 
1. A short description (2 sentences) of what the intent of your plot is (think in terms of our discussion and notebooks on how we show variation, co-variation in terms of central trend, spread, skew etc.),
...
* Tidy the Top 50 Solar Flare Data (15 pts)
